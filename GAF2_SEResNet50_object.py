...
CONFIG = {
    ...
    'output_dir':     '/kaggle/working/gaf2_object_features',
    'max_objects':    10,
    'conf_threshold': 0.5,
    'device': torch.device('cuda' if torch.cuda.is_available() else 'cpu'),
}

# GAF2: Train và Val, không có test, không chia thêm
SPLITS   = ['Train', 'Val']
...
def main():
    print("=" * 70)
    print("📦 GAF2 — TRÍCH XUẤT OBJECT (Faster-RCNN + SE-ResNet50)")
    print("=" * 70)
    ...
    for split in SPLITS:
        ...
        for emotion in EMOTIONS:
            # GAF2 có thể có cấu trúc Train/Positive/*.jpg
            # hoặc lồng nhau Train/Positive/Positive/*.jpg → dùng glob đệ quy
    ...
    print("\n⏳ Nén output...")
    shutil.make_archive('/kaggle/working/gaf2_object_features', 'zip',
                        '/kaggle/working/gaf2_object_features')
    print("✅ gaf2_object_features.zip")
